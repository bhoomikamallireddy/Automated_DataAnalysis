    ...
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4 font-sans text-zinc-900">
      <div className="w-full max-w-md bg-white rounded-[2.5rem] border border-zinc-200 shadow-xl p-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-zinc-900 mt-2">Reset Password</h1>
          <p className="text-zinc-500 text-sm mt-2 font-medium">Enter your email and we'll send you a link to get back into your account.</p>
        </div>
        ...
        {message ? (
          <div className="p-6 bg-blue-50 border border-blue-100 text-blue-700 rounded-2xl text-center">
            ...
            <Link href="/login" className="block mt-4 text-[10px] font-black uppercase text-blue-600 hover:underline">Return to Login</Link>
          </div>
        ) : (
